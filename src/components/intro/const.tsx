...
export const contSlide3 = (
  <>
    ...
    <Text size="sm">
      Кстати, если в базе отсутствует желанный тебе игрок -{" "}
      <Anchor href="/info" underline="always" target="_blank">
        свяжись с нами
      </Anchor>{" "}
      - мы оперативно добавим.
    </Text>
  </>
);
...
export const contSlide4 = (
  <>
    ...
    <Text size="sm">
      3. Если по итогам турнира нет победителя среди сделанных предсказаний, то
      накопленный призовой фонд по каждой дисциплине переходит в следующий
      Ивент.
    </Text>
  </>
);
